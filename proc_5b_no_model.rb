...
file_order ("#{@file_dir_hash['test_in_sample_2_dir']}/*.yaml")
s=""


@file_name.each do |item|

    file_out=File.open("#{@file_dir_hash['test_out_sample_2_dir']}/" + item +"_no_model.yaml","w+")

    yaml = YAML.load_file("#{@file_dir_hash['test_in_sample_2_dir']}/" + item +".yaml", aliases: true)
